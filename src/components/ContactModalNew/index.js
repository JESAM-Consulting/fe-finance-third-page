import "./ContactModalNew.scss";
import ModalLogo from "../../assets/icons/modal-logo.svg";
...
export default function ContactModalNew(props) {
  ...
  const submitContact = (e) => {
    ...
    if (validateforUserData()) {
      ApiPost(`applyContactForm/create`, inputValue)
        .then((res) => {
  ...
  //     eventValue: "Application",
  //   });
  //   global.fbq("trackCustom", "OpenApplicationForm");
  // }, []);
          ...
          <div className="white-box-new">
            ...
            <div className="modal-body">
              <div className="text-style">
                ...
                <h6 className="m-new-s">Du hast es fast geschafft!</h6>
